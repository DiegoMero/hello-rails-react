...
> A random greetin generator
## 🛠 Built With <a name="built-with"></a>

### Tech Stack <a name="tech-stack"></a>

> This project is made with Ruby on Rails and React.
<details>
  <summary>Client</summary>
  <ul>
    <li><a href="https://rubyonrails.org/">Ruby on Rails and React</a></li>
  </ul>
</details>
<details>
...
```sh
  cd folder
  git clone git@github.com:DiegoMero/hello-rails-react.git
```
